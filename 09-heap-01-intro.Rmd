...
## Heap Implementation {#intro-heap}
...
- Keep removing the largest element when heap size exceeds k
- Final heap contains k smallest elements
- Root of max heap is the k-th smallest element

**Pattern 2: Finding k Largest Elements**
- Use **min heap of size k**
- Keep removing the smallest element when heap size exceeds k
