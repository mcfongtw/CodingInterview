...
## Evaluate Reverse Polish Notation {#lc-evaluate-reverse-polish-notation}
...
- **Tags**: Grind 75
- **Techniques**: [Stack](glossary-of-algorithm.html#glossary-stack), String, Math
...
The evaluation strategy is simple:
- **Operand**: Push it onto the stack
- **Operator**: Pop two operands, apply the operation, push the result back
...
**Why?** In RPN `5 3 -`, we push 5, then 3. Stack looks like `[5, 3]` with 3 on top. When we pop:
...
- **Tags**: NeetCode 150, Grind 75, Top 100 Liked, Blind 75
...
## Daily Temperatures {#lc-daily-temperatures}
...
- **Tags**: NeetCode 150
- **Techniques**: [Stack](glossary-of-algorithm.html#glossary-stack), Monotonic Stack
...
A monotonic stack maintains elements in a specific order. In this problem:
- We store **indices** in the stack
- The **temperatures** at those indices are in **decreasing order** from bottom to top
- When we encounter a warmer temperature, it "breaks" the monotonic property and we pop elements
