...
## Battleships in a Board {#battleships-in-board}
...
There is a rectangular brick wall in front of you with several rows of bricks. The bricks have the same height but different widths. You want to draw a vertical line from the top to the bottom and cross the **least** bricks. The brick wall is represented by a list of rows, where each row is a list of integers representing the width of each brick in that row from left to right.
