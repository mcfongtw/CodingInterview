...
#### Three Sum Family (LeetCode 15, 16, 259)
...
**Key differences and picks:** All three require sorting to enable the inner two-pointer sweep. 3Sum needs dedup to emit unique triplets; 3Sum Closest tracks best distance; 3Sum Smaller exploits sorted order to count valid pairs in bulk when the sum is already below target.
