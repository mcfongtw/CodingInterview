## Validate Properly Nested Brackets {#hr-validate-nested-brackets}
...
- **Tags**: Stack
- **Techniques**: [Stack](\@ref(glossary-stack))
...
## Next Greater Element with Position Offset {#hr-next-greater-offset}
...
- **Techniques**: [Stack](\@ref(glossary-stack)), [Monotonic Stack](\@ref(monotonic-stack))
...
2. **Initialize data structures**:
   - Create result lc-list, initializing each entry with immutable `[-1, -1]` (note: will use `set()` to update)
