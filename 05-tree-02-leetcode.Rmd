...
Use DFS to return the depth of each subtree. At every node, update the diameter with `leftDepth + rightDepth` and return `1 + max(leftDepth, rightDepth)` to the parent.
